...
const { getProfile, getAllProfile, getDonationRecord, getAllHospitalProfile, getHospitalSummary, getFeedback, getAvatar } = require('../controllers/userAPI');
...
router.route('/get-avatar/:username').get(getAvatar);
//hospital
